...
function cancelHold(holdID) {
    ...
    xmlhttps.open(
        'POST',
        'https://arif115.myweb.cs.uwindsor.ca/hogwartslibrary/api/library/cancelHoldBooks',
        true
    );
...
function renderHoldStatus() {
    ...
    if (holdSuccess > 0) {
        holdStatusText +=
            'You have successfully canceled ' + holdSuccess + ' book';
        if (holdSuccess > 1) {
...
function userHolds() {
    ...
    var url =
        'https://arif115.myweb.cs.uwindsor.ca/hogwartslibrary/api/user/userHolds';
