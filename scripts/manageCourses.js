...
function deleteCourses() {
    ...
    var url =
        'https://arif115.myweb.cs.uwindsor.ca/hogwartslibrary/api/headmaster/deleteCourses';
...
function addCourse() {
    ...
    var professorID = document
        .getElementById('professorSelection')
        .value.trim();
    ...
    var xmlhttp = new XMLHttpRequest();
    var url =
        'https://arif115.myweb.cs.uwindsor.ca/hogwartslibrary/api/headmaster/addCourses';
    xmlhttp.open('POST', url, true);
    xmlhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            console.log(this.responseText);
...
function getProfessorList(professorJSON) {
    //display list of professors in drop-down box
